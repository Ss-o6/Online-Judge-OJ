            ...
            >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    ...
                    <Typography
                        component="h1"
                        variant="h5"
                        sx={{ color: '#5D866C', fontFamily: 'Roboto Slab, serif', fontWeight: 'bold' }}
                    >
                        Forgot Password
                    </Typography>
                    ...
                    <form noValidate style={{ width: '100%', marginTop: '20px' }}>
                        ...
                        <Button
                            ...
                            sx={{
                                mt: 2,
                                mb: 2,
                                bgcolor: '#3D5AFE', // main blue button
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '10px' }}>
                            <Link href="/login" variant="body2" sx={{ color: '#2b583bff' }}>
                                Back to Login
                            </Link>
                            <Link href="/register" variant="body2" sx={{ color: '#2b583bff' }}>
